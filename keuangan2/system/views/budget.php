...
$fmod='budget';
$xtable=new xtable($fmod,'anggaran');
...
if($xtable->ndata>0){
	// Table head
	$xtable->head('Nama Anggarang','Anggaran','Status anggaran','Keterangan');
	while($r=mysql_fetch_array($t)){$xtable->row_begin();
		...
		$s='<div class="sfont" style="width:480px;height:20px;padding:1px;text-align:left"><span style="float:left">Total anggaran: <b>'.fRp($r['nominal']).'</b></span></div>';
