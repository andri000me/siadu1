...
$sel=0;
if($ct_pemasukan!=0) $sel++;
if($ct_pengeluaran!=0) $sel++;
...
echo '<div class="sfont" style="float:left;width:100%;margin-top:20px;margin-bottom:10px"><b>Tampilkan catatan transaksi:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',
